...
* This mean value is linearly transformed from the range [0, 1] to the range [\code{ple_0}, \code{ple_1}] with this formula. Say the mean value is `x`. Then the computed path loss exponent value is `y = ple_0 + x * (ple_1 - ple_0)`.
