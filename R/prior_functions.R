...
#'
#' The function \code{create_coverage_map} is used to create a coverage map
...
#' @param prior prior object, the result of \code{\link{extract_uniform_prior}}, \code{\link{create_prior}}, or \code{\link{extract_network_prior}}
#' @export
